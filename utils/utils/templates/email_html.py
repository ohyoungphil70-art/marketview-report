...
<tr><td align="center">
<table width="680" cellpadding="0" cellspacing="0" style="background:{C_BG};border-radius:12px;overflow:hidden;border:1px solid #1e2d45;max-width:680px;width:100%;">
<tr><td style="background:linear-gradient(135deg,#111827 0%,#1a2235 100%);padding:24px 28px;border-bottom:2px solid {C_ACC};"><table width="100%" cellpadding="0" cellspacing="0"><tr><td><div style="font-size:28px;font-weight:700;color:{C_TEXT};">MARKET<span style="color:{C_ACC};">VIEW</span></div><div style="font-size:10pt;color:{C_MUTE};margin-top:3px;">Daily Market Report &nbsp;|&nbsp; {date_str}</div></td><td align="right"><div style="background:rgba(245,158,11,.15);border:1px solid rgba(245,158,11,.3);border-radius:6px;padding:6px 12px;font-size:10pt;color:{C_ACC};">📈 시황 리포트</div></td></tr></table></td></tr>
{greeting_html}
